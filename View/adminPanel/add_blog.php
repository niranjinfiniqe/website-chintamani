                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" required name="BlogTitle" type="text" placeholder="" id="BlogTitle">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="example-text-input" class="form-label">Blog Owner</label>
                                                    <input class="form-control" name="BlogOwner" type="text" placeholder="" id="ProjectAlias">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="example-search-input" class="form-label">Blog Date</label>
                                                    <input class="form-control" name="BlogDate" type="Date" placeholder="" id="ProjectAlias">
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-3 mt-lg-0">
                                                <div class="mb-3">
                                                    ...
                                                    <input onkeyup="aliascheck(this.value)" class="form-control" name="BlogAlias" type="text" placeholder="" id="BlogAlias">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="example-search-input" class="form-label">Reading Time(Min.)</label>
                                                    <input class="form-control" name="ReadingTime" type="number" placeholder="" id="ReadingTime">
                                                </div>
                                                <div class="mb-3">
