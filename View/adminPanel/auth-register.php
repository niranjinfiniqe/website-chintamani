...
<!-- Mirrored from minia.php.themesbrand.com/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 May 2022 06:03:31 GMT -->
<head>
                            ...
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        ...
                                        <form class="needs-validation mt-4 pt-2" novalidate method="post" action="register.php">
                                            <div class="mb-3">
                                                <label for="useremail" class="form-label">Email</label>
                                                <input type="email" class="form-control" name="emailId" id="useremail" placeholder="Enter email" required>  
...
<!-- Mirrored from minia.php.themesbrand.com/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 May 2022 06:03:32 GMT -->
</html>