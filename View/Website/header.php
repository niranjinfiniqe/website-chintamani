   ...
   <head>
      ...
      <title>chintamani Venture &#8211; chintamani Venture</title>
   ...
   <body style="background:pink" class="home page-template page-template-elementor_header_footer page page-id-18618 using-mobile-header-sticky elementor-default elementor-template-full-width elementor-kit-22 elementor-page elementor-page-18618">
         ...
         <div class="snap-drawers">
            <div class="snap-drawer snap-drawer-left">
               ...
               <ul id="menu-main-menu" class="mobilex-menu">
                  ...
                  <li id="menu-item-18169" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-5707 current_page_item menu-item-18169"><a href="contact us.php" aria-current="page">Contact</a></li>
               </ul>
            </div>
         </div>
      </div>
      ...
      <div class="master_header   wide   topbar_transparent  ">
         ...
         <div class="header_wrapper   header_type1 header_center hover_type_2 header_alignment_text_left  no_property_submit ">
            <div class="header_wrapper_inside  " data-logo="https://las-vegas.b-cdn.net/wp-content/uploads/2022/03/las-vegas.png" data-sticky-logo="https://las-vegas.b-cdn.net/wp-content/uploads/2022/03/las-vegas.png">
               <div class="logo">
                  <a href="https://lasvegas.wpresidence.net/">
                  <img id="logo_image" style="margin-top:0px;" src="https://las-vegas.b-cdn.net/wp-content/uploads/2022/03/las-vegas.png" class="img-responsive retina_ready" alt="company logo" />
                  </a>
               </div>
               <div class="user_menu user_not_loged" id="user_menu_u">
                  ...
                  <div class="header_phone">
                     ...
                     <a href="tel:  +91 22 66954091">  +91 22 66954091</a>
                  </div>
               </div>
               <nav id="access">
                  <div class="menu-main-menu-container">
                     <ul id="menu-main-menu" class="menu">
                        <li id="menu-item-19214" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-18618 current_page_item no-megamenu">
                           <a class="menu-item-link" href="index.php">Home</a>
                        </li>
                        <li id="menu-item-20475" class="menu-item menu-item-type-custom menu-item-object-custom no-megamenu">
                           <a class="menu-item-link" target="_blank" href="aboutUs.php">About Us</a>
                        </li>
