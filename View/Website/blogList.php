...
$exce = mysqli_query($con,"select * from blog_master where isDeleted = 0");
// For Pagination
...
<div class="col-md-4  listing_wrapper blog2v">
									<div class="property_listing_blog" data-link="https://lasvegas.wpresidence.net/2016/03/04/top-10-best-appreciating-condos-in-las-vegas/">
										...
										<a href="SingleBlog.php?pid=<?php echo $pro["PK_BlogID"]; ?>">
											<img width="525" height="328" src="<?php echo $pro['BlogThumbImage']?>" class="lazyload img-responsive wp-post-image" alt="" loading="lazy" data-original="" /></a></div>
										<div><h4><a href="SingleBlog.php?pid=<?php echo $pro["PK_BlogID"]; ?>">
										...
										<a class="read_more" href="SingleBlog.php?pid=<?php echo $pro["PK_BlogID"]; ?>"> Continue reading<i class="fas fa-angle-right"></i> </a>
...
?>
				...
				<li class="<?php if ($Pageid == $i) echo 'active'; ?>"> <a id="hover" href="blogList.php?page_id=<?php echo $i;?>"><?php echo $i; ?></a>
		<li>
	<?php } ?>
