...
<div class="header_media  mobile_header_media_sticky_yes header_mediatype_12 with_search_1 header_media_non_elementor">

<div class="gallery_wrapper property_header_gallery_wrapper">
	<!-- <div class="status-wrapper"></div> -->

	<div class="col-md-6 image_gallery lightbox_trigger special_border" data-slider-no="1" style="background-image:url(https://las-vegas.b-cdn.net/wp-content/uploads/2021/10/interior35.jpg)  "> <div class="img_listings_overlay"></div></div>


	<div  data-toggle="modal" data-target="#exampleModalCenter" class="col-md-3 image_gallery lightbox_trigger  special_border_top  " data-slider-no="2" style="background-image:url(https://las-vegas.b-cdn.net/wp-content/uploads/2014/05/house4-800x467.jpg);opacity:0.2"> <div class="img_listings_overlay"></div><span class="img_listings_mes"><i class="fa fa-lock fa-lg font-size-24"></i></span> </div>

	<div  data-toggle="modal" data-target="#exampleModalCenter" class="col-md-3 image_gallery lightbox_trigger  special_border_top  " data-slider-no="3" style="background-image:url(https://las-vegas.b-cdn.net/wp-content/uploads/2014/05/house6-800x467.jpg);;opacity:0.8"> <div class="img_listings_overlay">
	<i class="fa fa-lock fa-lg font-size-24"></i></span>
	</div><span class="img_listings_mes"><i class="fa fa-lock fa-lg font-size-50"></i></span> </div>

	<div  data-toggle="modal" data-target="#exampleModalCenter" class="col-md-3 image_gallery lightbox_trigger" data-slider-no="4" style="background-image:url(https://las-vegas.b-cdn.net/wp-content/uploads/2014/05/house8-800x467.jpg);opacity:0.8"> <div class="img_listings_overlay"></div><span class="img_listings_mes"><i class="fa fa-lock fa-lg font-size-50"></i></span> </div>

	<div  data-toggle="modal" data-target="#exampleModalCenter" class="col-md-3 image_gallery last_gallery_item lightbox_trigger" data-slider-no="5" style="background-image:url(https://las-vegas.b-cdn.net/wp-content/uploads/2014/05/house11-800x467.jpg);opacity:0.8  ">


	<div data-toggle="modal" data-target="#exampleModalCenter" class="img_listings_overlay img_listings_overlay_last"></div><span class="img_listings_mes"><i class="fa fa-lock fa-lg  font-size-24"></i></span></div>
</div>
...
<input type="hidden" id="security-login-topbar" name="security-login-topbar" value="4d69fdb93d-1654499327">
...
<input type="hidden" id="security-register-topbar" name="security-register-topbar" value="d7eddf956b-1654499327">
...
<input type="hidden" id="security-forgot-topbar" name="security-forgot-topbar" value="6891b81c44" /><input type="hidden" name="_wp_http_referer" value="/blog-list-no-sidebar/" /> <input type="hidden" id="postid" value="
                        17988">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLongTitle">Please Login to Proceed</h5>
...
<!-- </form>
	...
	<div class="text-center ">Do not have account? <a> SignUP</a></div>
	  <style>
		a:hover{
			cursor: pointer;
...
<li><a href="https://lasvegas.wpresidence.net/">Home</a></li><li><a href="https://lasvegas.wpresidence.net/property_category/houses/" rel="tag">Houses</a></li><li class="active"><?php echo $lease["Lease_Name"]; ?></li></ol></div>
...
</a></div><div class="property_title_label actioncat"><a href="https://lasvegas.wpresidence.net/property_category/houses/" rel="tag">Houses</a></div></div>
...
<?php echo  $lease["CompleteAddress"]; ?> </div>
...
<h4 class="panel-title"> Description</h4><p><?php echo $lease["LongDescription"];?></p>
</div>
...
<div class="listing_detail col-md-6"><strong>Address: &nbsp;</strong><?php echo $lease["CompleteAddress"]; ?></div><div class="listing_detail col-md-6"><strong>City:</strong> <a href="https://lasvegas.wpresidence.net/property_city/las-vegas/" rel="tag">Mumbai</a></div><div class="listing_detail col-md-6"><strong>Area:</strong> <a href="https://lasvegas.wpresidence.net/property_area/downtown/" rel="tag">Andheri</a></div><div class="listing_detail col-md-6"><strong>State:</strong> <a href="https://lasvegas.wpresidence.net/property_county_state/nevada/" rel="tag">Maharashtra</a></div><div class="listing_detail col-md-6"><strong>Zip:</strong> NV 89147</div><div class="listing_detail col-md-6"><strong>Country:&nbsp;</strong>India</div> <a href="https://maps.google.com/?q=8367+W+Flamingo+Rd+suite+101%2CLas+Vegas" target="_blank" rel="noopener" class="acc_google_maps">Open In Google Maps</a> </div>
</div>
</div>
</div>
...
<div class="panel-body">
<div class="listing_detail col-md-6" id="propertyid_display"><strong>Lease Id :</strong> <?php echo  $lease['PK_lease']; ?></div><div class="listing_detail col-md-6"><strong>Price:</strong><?php echo $lease["Price"]; ?><span class="price_label"></span></div><div class="listing_detail col-md-6"><strong>Property Size:</strong> <?php echo $lease["BuildUpArea"]; ?> ft<sup>2</sup></div>
