<div class="master_header   wide   topbar_transparent  ">
    <div class="mobile_header mobile_header_sticky_yes">
        ...
        <div class="mobile-logo">
            <a href="index">
            <img src="uploads/chinatamani_1.png" class="img-responsive retina_ready " alt="image" /> </a>
        </div>
    ...
    <div class="header_wrapper   header_type1 header_center hover_type_2 header_alignment_text_left  no_property_submit ">
        <div class="header_wrapper_inside  " data-logo="uploads/chinatamani_1.png" data-sticky-logo="uploads/chinatamani_1.png">
            <div class="logo">
                <a href="index"><img id="logo_image" style="margin-top:0px;" src="uploads/chinatamani_1.png" class="img-responsive retina_ready" alt="chinatamani" /></a>
            </div>
            ...
            <nav id="access">
                <div class="menu-main-menu-container" >
                    <ul id="menu-main-menu" class="menu" style="padding-left:200px;">
                        <li id="menu-item-19214" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-18618 current_page_item no-megamenu   "><a class="menu-item-link" href="index">Home</a></li>
                        <!-- <li id="menu-item-20475" class="menu-item menu-item-type-custom menu-item-object-custom no-megamenu   ">
                            <a class="menu-item-link" target="" href="aboutUs">About Us</a></li> -->
                            ...
                            <li id="menu-item-853" class="menu-item menu-item-type-post_type menu-item-object-estate_agent menu-item-853"><a href="our_story">Our Story</a></li>
                            <li id="menu-item-18162" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-18162"><a href="our_ins">Our inspiration</a></li>
                            </ul>
                            </li>
                                                
                        <li id="menu-item-837" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children no-megamenu   ">
                            <a class="menu-item-link" href="leasing">Leasing</a>
                        </li>
                        ...
                        <!-- <li id="menu-item-838" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children no-megamenu   ">
                            <a class="menu-item-link" href="blogList">Blogs</a>
                        </li> -->
                        <li id="menu-item-18169" class="menu-item menu-item-type-post_type menu-item-object-page no-megamenu">
                            <a class="menu-item-link" href="contactUs">Contact Us</a></li>
                    </ul>
                </div>
            </nav>
        </div>
