				...
				<div class=" col-md-12 rightmargin ">
						...
						?>
							...
							<div class="col-md-4 listing_wrapper">
								<div class="agent_unit">
									...
									<div class="agent-unit-img-wrapper" data-link="SingleProject?pid=<?php echo $pro["PK_Project"]; ?>">
										<img style="" alt="<?php echo $pro['ThumbnailImageURL']; ?>" src="<?php echo $pro['ThumbnailImageURL']; ?>" class="lazyload img-responsive wp-post-image" alt="" loading="lazy" srcset="" sizes="(max-width: 500px) 100vw, 500px" />
									...
									<h4> <a href="SingleProject?pid=<?php echo $pro["PK_Project"]; ?>">
					...
					<ul class="pagination pagination_nojax">
						...
						?>
							...
							<li class="<?php if ($Pageid == $i) echo 'active'; ?>"> <a id="hover" href="Projects?page_id=<?php echo $i; ?>"><?php echo $i; ?></a>
							<li>
							<?php } ?>
