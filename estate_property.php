		...
		<div class="container content_wrapper">
			<div class="row">
				<!-- <div class="gallery_wrapper property_header_gallery_wrapper">
					...
					<div class="col-md-6 image_gallery lightbox_trigger special_border" data-slider-no="1" style="background-image:url('<?php echo $lease['Images']; ?>')  ">
						<div class="img_listings_overlay "></div>
					</div>
					<div class="col-md-3 image_gallery lightbox_trigger  special_border_top  myBtn " data-slider-no="2" style="background-image:url();">
						<div class="img_listings_overlay"></div>
						<span class="img_listings_mes"><i style="color:black;" class="fas fa-lock fa-lg"></i></span>
					</div>
					<div class="col-md-3 image_gallery lightbox_trigger  special_border_top  myBtn " data-slider-no="3" style="background-image:url();">
						<div class="img_listings_overlay"></div>
						<span class="img_listings_mes"><i style="color:black;" class="fas fa-lock fa-lg"></i></span>
					</div>
					<div class="col-md-3 image_gallery lightbox_trigger  myBtn" data-slider-no="4" style="background-image:url();">
						<div class="img_listings_overlay"></div>
						<span class="img_listings_mes"><i style="color:black;" class="fas fa-lock fa-lg"></i></span>
					</div>
					<div class="col-md-3 image_gallery last_gallery_item lightbox_trigger  myBtn" data-slider-no="5" style="background-image:url();  ">
				...
				<div class="gallery_wrapper property_header_gallery_wrapper">
							<div class="status-wrapper"></div>
							<div class="col-md-6 image_gallery lightbox_trigger special_border" data-slider-no="1">
							<img src="https://las-vegas.b-cdn.net/wp-content/uploads/2014/05/house6-800x467.jpg" alt="">
								<div class="img_listings_overlay "></div>
							</div>
							<div  class="col-md-3 image_gallery lightbox_trigger  special_border_top  myBtn " data-slider-no="2" >
								<img src="https://las-vegas.b-cdn.net/wp-content/uploads/2014/05/house6-800x467.jpg" alt="" style="opacity:0.1;filter: brightness(90%);">
								<div class="img_listings_overlay" ></div>
								<span class="img_listings_mes"><i class="fas fa-lock fa-lg"></i></span>
							</div>
							<div  class="col-md-3 image_gallery lightbox_trigger  special_border_top  myBtn " data-slider-no="3" >
							<img src="https://las-vegas.b-cdn.net/wp-content/uploads/2014/05/house6-800x467.jpg" alt="" style="opacity:0.1;filter: brightness(90%);">
								<div class="img_listings_overlay"></div>
								<span class="img_listings_mes"  ><i class="fas fa-lock fa-lg"></i></span>
							</div>
							<div class="col-md-3 image_gallery lightbox_trigger  myBtn" data-slider-no="4">
							<img src="https://las-vegas.b-cdn.net/wp-content/uploads/2014/05/house6-800x467.jpg" alt="" style="opacity:0.1;filter: brightness(90%);">
								<div class="img_listings_overlay"></div>
								<span class="img_listings_mes" ><i class="fas fa-lock fa-lg"></i></span>
							</div>
							<div  class="col-md-3 image_gallery last_gallery_item lightbox_trigger  myBtn" data-slider-no="5" >
							<img src="https://las-vegas.b-cdn.net/wp-content/uploads/2014/05/house6-800x467.jpg" alt="" style="opacity:0.1;filter: brightness(90%);">
								<div class="myBtn" class="img_listings_overlay img_listings_overlay_last"></div>
								<span class="img_listings_mes"  ><i class="fas fa-lock fa-lg"></i></span>
				...
				<div class="modal_login_container " style='height:520px;'>
					...
					<div id="myModal" class="modal">
						<!-- <div style="border:2px solid red;" class="modal_login_back"></div> -->
						...
						<div class="modal_login_container " style='height:520px;'>
							...
							<div class="login-register-modal-form-wrapper">
								...
								<i onclick="dis()" class="fas fa-times fa-lg"></i>
								<!-- <button onclick="dis()" >close</button> -->
								<div class="login_form" id="login-div_topbar">
						...
						<div class="single-content listing-content">
							<div class="single-overview-section panel-group property-panel">
								...
								<ul class="overview_element">
									...
									<li class="first_overview_date">March 29, 2023</li>
								</ul>
								...
								<ul class="overview_element">
									<li class="first_overview">
									<svg width="600" height="600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
								...
								<div class="panel panel-default">
									...
									<div id="collapseOne" class="panel-collapse collapse in">
										<div class="panel-body">
											<?php
											$TotalWashroomCount = 0;
											while ($row = mysqli_fetch_array($exce)) {

											?>

												<div class=" col-md-6" id="propertyid_display"><strong>
														<?php if ($row['amenity_name'] == "ReceptionArea") {
															echo "Reception Area :&nbsp;" . $row['Count'];
														}
														if ($row['amenity_name'] == "SR_Manage") {
															echo "Senior Manager :&nbsp;" . $row['Count'];
														}
														if ($row['amenity_name'] == "CabinsCount") {
															echo "Cabins :&nbsp;" . $row['Count'];
														}
														if ($row['amenity_name'] == "W/S") {
															echo "WorkStation :&nbsp;" . $row['Count'];
														}
														if ($row['amenity_name'] == "ConferenceRoomCount") {
															echo "Conference Rooms:&nbsp;" . $row['Count'];
														}
														if ($row['amenity_name'] == "ServerRoomCount") {
															echo "Server Rooms:&nbsp;" . $row['Count'];
														}
														if ($row['amenity_name'] == "GeneralWashroom") {
															$TotalWashroomCount += $row["Count"];
														}
														if ($row['amenity_name'] == "GentsWashroomCount") {
															$TotalWashroomCount += $row["Count"];
														}
														if ($row['amenity_name'] == "ladiesWashroom") {
															$TotalWashroomCount += $row["Count"];
															echo "Washrooms:&nbsp;" . $TotalWashroomCount;
														}
								...
								<div class="panel panel-default">
									...
									<div id="collapseThree" class="panel-collapse collapse in">
										<div class="panel-body">
											...
											$features_query = "SELECT  features_master.Feature_Name FROM lease_features INNER JOIN features_master ON features_master.feature_id = lease_features.FK_features WHERE lease_features.FK_Lease = $pid; ";
											$features = mysqli_query($con, $features_query);
											foreach ($features as $key => $feature) {
												if ($feature['Feature_Name'] == "Equipped Pantry" || $feature['Feature_Name'] == "Store Room") {
											...
											?>
													<div class="listing_detail col-md-12 feature_block_Interior Details ">
														...
														foreach ($features as $key => $feature) {
															if ($feature['Feature_Name'] == "Store Room") {
											...
											$features = mysqli_query($con, $features_query);
											foreach ($features as $key => $feature) {
												if ($feature['Feature_Name'] == "Central Air" || $feature['Feature_Name'] == "Electricity" || $feature['Feature_Name'] == "Heating" || $feature['Feature_Name'] == "Ventilation" || $feature['Feature_Name'] == "Water") {
											...
											?>
													...
													<div class="listing_detail col-md-12 feature_block_Utilities ">
														...
														foreach ($features as $key => $feature) {
															if ($feature['Feature_Name'] == "Central Air") {
														...
														foreach ($features as $key => $feature) {
															if ($feature['Feature_Name'] == "Electricity") {
														...
														foreach ($features as $key => $feature) {
															if ($feature['Feature_Name'] == "Heating") {
														...
														foreach ($features as $key => $feature) {
															if ($feature['Feature_Name'] == "Ventilation") {
											...
											foreach ($features as $key => $feature) {
												if ($feature['Feature_Name'] == "Elevator" || $feature['Feature_Name'] == "Smoke detectors"  || $feature['Feature_Name'] == "WiFi") {
											...
											?>
													<div class="listing_detail col-md-12 feature_block_others ">
														...
														<?php
														foreach ($features as $key => $feature) {
															if ($feature['Feature_Name'] == "Elevator") {
														...
														<?php
														foreach ($features as $key => $feature) {
															if ($feature['Feature_Name'] == "Smoke detectors") {
										...
										<div id="collapseThreeOne" class="panel-collapse collapse in">
											<div class="panel-body">
												<div class="property_video_wrapper">
													...
													<a href="#" data-autoplay="true" data-vbtype="video" class="venobox"><img src="<?php
							...
							<?php
							if (strlen($lease['FloorPlanURL']) > 0) {
							?>
											...
											<div class="panel-body">
												...
												<div class="front_plan_row_image " style="display:block" ;>
													<div class="floor_image">
														<a href="" rel="prettyPhoto" title="Living Spaces are more easily interpreted. All-In-Ones color floor plan option clearly defines your listing’s living spaces, making them obvious and clearly visible to your potential buyers/clients. Add extra value to your services. Color floor-plans show that you care about selling your client’s listing; they add a premium, high value look to any listing and can be used in your brochures, email and websites."><img class="lightbox_trigger_floor" data-slider-no="1" src="<?php echo $lease['FloorPlanURL'] ?>" alt="Floor plan A"></a>
													</div>
